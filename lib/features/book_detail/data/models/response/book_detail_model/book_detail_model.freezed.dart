...
class _$BookDetailModelImpl implements _BookDetailModel {
  ...
  @override
  String toString() {
    return 'BookDetailModel(id: $id, year: $year, title: $title, handle: $handle, publisher: $publisher, isbn: $isbn, pages: $pages, notes: $notes, createdAt: $createdAt, villains: $villains)';
  }
...
abstract class _BookDetailModel implements BookDetailModel {
  factory _BookDetailModel(
      ...
      final List<VillainModel>? villains}) = _$BookDetailModelImpl;
